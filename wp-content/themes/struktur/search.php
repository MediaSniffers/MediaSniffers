<?php
$qodef_search_holder_params = struktur_select_get_holder_params_search();
?>
<?php get_header(); ?>
<?php struktur_select_get_title(); ?>
<?php do_action('struktur_select_action_before_main_content'); ?>
	<div class="<?php echo esc_attr( $qodef_search_holder_params['holder'] ); ?>">
		...
		<div class="<?php echo esc_attr( $qodef_search_holder_params['inner'] ); ?>">
			<?php struktur_select_get_search_page(); ?>
		</div>
