...
if ( ! function_exists( 'struktur_select_add_dripicons_icon_pack' ) ) {
	function struktur_select_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new StrukturSelectClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'struktur_select_filter_add_icon_pack_into_collection', 'struktur_select_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'struktur_select_add_dripicons_icon_pack_option' ) ) {
	function struktur_select_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'struktur' );
		
		return $options;
	}
	
	add_filter( 'struktur_select_filter_add_icon_pack_into_options', 'struktur_select_add_dripicons_icon_pack_option' );
}

class StrukturSelectClassDripicons implements iStrukturSelectInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->param = $param;
        $this->setIconsArray();
        $this->styleUrl = STRUKTUR_SELECT_FRAMEWORK_ICONS_ROOT . '/dripicons/dripicons.css';
    }
