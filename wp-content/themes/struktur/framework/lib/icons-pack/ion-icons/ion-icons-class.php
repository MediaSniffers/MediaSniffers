...
if ( ! function_exists( 'struktur_select_add_ion_icon_pack' ) ) {
	function struktur_select_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new StrukturSelectClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'struktur_select_filter_add_icon_pack_into_collection', 'struktur_select_add_ion_icon_pack' );
}

if ( ! function_exists( 'struktur_select_add_ion_icon_pack_option' ) ) {
	function struktur_select_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'struktur' );
		
		return $options;
	}
	
	add_filter( 'struktur_select_filter_add_icon_pack_into_options', 'struktur_select_add_ion_icon_pack_option' );
	add_filter( 'struktur_select_filter_add_icon_pack_into_social_options', 'struktur_select_add_ion_icon_pack_option' );
}

class StrukturSelectClassIonIcons implements iStrukturSelectInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = STRUKTUR_SELECT_FRAMEWORK_ICONS_ROOT . '/ion-icons/css/ionicons.min.css';
	}
