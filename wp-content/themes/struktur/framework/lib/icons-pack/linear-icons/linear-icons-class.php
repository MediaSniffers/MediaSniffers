...
if ( ! function_exists( 'struktur_select_add_linear_icon_pack' ) ) {
	function struktur_select_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new StrukturSelectClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'struktur_select_filter_add_icon_pack_into_collection', 'struktur_select_add_linear_icon_pack' );
}

if ( ! function_exists( 'struktur_select_add_linear_icon_pack_option' ) ) {
	function struktur_select_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'struktur' );
		
		return $options;
	}
	
	add_filter( 'struktur_select_filter_add_icon_pack_into_options', 'struktur_select_add_linear_icon_pack_option' );
}

class StrukturSelectClassLinearIcons implements iStrukturSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = STRUKTUR_SELECT_FRAMEWORK_ICONS_ROOT . '/linear-icons/style.css';
	}
