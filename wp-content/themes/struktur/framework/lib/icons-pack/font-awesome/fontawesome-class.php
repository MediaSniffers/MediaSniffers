...
if ( ! function_exists( 'struktur_select_add_font_awesome_icon_pack' ) ) {
	function struktur_select_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new StrukturSelectClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'struktur_select_filter_add_icon_pack_into_collection', 'struktur_select_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'struktur_select_add_font_awesome_icon_pack_option' ) ) {
	function struktur_select_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'struktur' );
		
		return $options;
	}
	
	add_filter( 'struktur_select_filter_add_icon_pack_into_options', 'struktur_select_add_font_awesome_icon_pack_option' );
	add_filter( 'struktur_select_filter_add_icon_pack_into_social_options', 'struktur_select_add_font_awesome_icon_pack_option' );
}

class StrukturSelectClassIconsFontAwesome implements iStrukturSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = STRUKTUR_SELECT_FRAMEWORK_ICONS_ROOT . '/font-awesome/css/fontawesome-all.min.css';
	}
	...
	private function getNewIconsArray( $brandsIcons = false ) {
		...
		$iconsArray = array();
		$icons      = json_decode( $wp_filesystem->get_contents( STRUKTUR_SELECT_FRAMEWORK_ICONS_ROOT_DIR . '/font-awesome/icons.json' ) );
