...
if ( ! function_exists( 'struktur_select_add_font_elegant_icon_pack' ) ) {
	function struktur_select_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new StrukturSelectClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'struktur_select_filter_add_icon_pack_into_collection', 'struktur_select_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'struktur_select_add_font_elegant_icon_pack_option' ) ) {
	function struktur_select_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'struktur' );
		
		return $options;
	}
	
	add_filter( 'struktur_select_filter_add_icon_pack_into_options', 'struktur_select_add_font_elegant_icon_pack_option' );
	add_filter( 'struktur_select_filter_add_icon_pack_into_social_options', 'struktur_select_add_font_elegant_icon_pack_option' );
}

class StrukturSelectClassIconsFontElegant implements iStrukturSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = STRUKTUR_SELECT_FRAMEWORK_ICONS_ROOT . '/elegant-icons/style.min.css';
	}
