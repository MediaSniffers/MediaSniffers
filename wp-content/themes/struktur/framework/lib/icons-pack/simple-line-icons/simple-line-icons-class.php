...
if ( ! function_exists( 'struktur_select_add_simple_line_icon_pack' ) ) {
	function struktur_select_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new StrukturSelectClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'struktur_select_filter_add_icon_pack_into_collection', 'struktur_select_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'struktur_select_add_simple_line_icon_pack_option' ) ) {
	function struktur_select_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'struktur' );
		
		return $options;
	}
	
	add_filter( 'struktur_select_filter_add_icon_pack_into_options', 'struktur_select_add_simple_line_icon_pack_option' );
	add_filter( 'struktur_select_filter_add_icon_pack_into_social_options', 'struktur_select_add_simple_line_icon_pack_option' );
}

class StrukturSelectClassSimpleLineIcons implements iStrukturSelectInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = STRUKTUR_SELECT_FRAMEWORK_ICONS_ROOT . '/simple-line-icons/simple-line-icons.css';
    }
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'struktur'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'struktur'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'struktur'),
            'icon-social-facebook'    => esc_html__('Facebook', 'struktur'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'struktur'),
            'icon-social-github'      => esc_html__('Github', 'struktur'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'struktur'),
            'icon-social-instagram'   => esc_html__('Instagram', 'struktur'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'struktur'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'struktur'),
            'icon-social-reddit'      => esc_html__('Reddit', 'struktur'),
            'icon-social-skype'       => esc_html__('Skype', 'struktur'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'struktur'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'struktur'),
            'icon-social-spotify'     => esc_html__('Spotify', 'struktur'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'struktur'),
            'icon-social-twitter'     => esc_html__('Twitter', 'struktur'),
            'icon-social-youtube'     => esc_html__('Youtube', 'struktur')
        );
    }
