...
if ( ! function_exists( 'struktur_select_get_hide_dep_for_header_logo_area_meta_boxes' ) ) {
	function struktur_select_get_hide_dep_for_header_logo_area_meta_boxes() {
		$hide_dep_options = apply_filters( 'struktur_select_filter_header_logo_area_hide_meta_boxes', $hide_dep_options = array() );
...
if ( ! function_exists( 'struktur_select_header_logo_area_meta_options_map' ) ) {
	function struktur_select_header_logo_area_meta_options_map( $header_meta_box ) {
		$hide_dep_options = struktur_select_get_hide_dep_for_header_logo_area_meta_boxes();
		...
		struktur_select_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Logo Area Style', 'struktur' )
			)
		);
		...
		struktur_select_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Set grid background transparency for logo area (0 = fully transparent, 1 = opaque)', 'struktur' ),
				'parent'      => $logo_area_in_grid_container,
				'args'        => array(
					'col_width' => 2
				)
		...
		struktur_select_create_meta_box_field(
			array(
				...
				'description'   => esc_html__( 'Set border on grid logo area', 'struktur' ),
				'parent'        => $logo_area_in_grid_container,
				'default_value' => '',
				'options'       => struktur_select_get_yes_no_select_array()
			)
		...
		struktur_select_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Choose a background color for logo area', 'struktur' ),
				'parent'      => $logo_area_container
			)
		);
		...
		struktur_select_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Choose a transparency for the logo area background color (0 = fully transparent, 1 = opaque)', 'struktur' ),
				'parent'      => $logo_area_container,
				'args'        => array(
					'col_width' => 2
				)
		...
		$logo_area_border_bottom_color_container = struktur_select_add_admin_container(
			array(
				'type'            => 'container',
		...
		do_action( 'struktur_select_action_header_logo_area_additional_meta_boxes_map', $logo_area_container );
	}
	
	add_action( 'struktur_select_action_header_logo_area_meta_boxes_map', 'struktur_select_header_logo_area_meta_options_map', 10, 1 );
}