...
if ( ! function_exists( 'struktur_select_get_hide_dep_for_header_menu_area_options' ) ) {
	function struktur_select_get_hide_dep_for_header_menu_area_options() {
		$hide_dep_options = apply_filters( 'struktur_select_filter_header_menu_area_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'struktur_select_header_menu_area_options_map' ) ) {
	function struktur_select_header_menu_area_options_map( $panel_header ) {
		$hide_dep_options = struktur_select_get_hide_dep_for_header_menu_area_options();
		...
		struktur_select_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set grid background transparency for menu area', 'struktur' ),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		struktur_select_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set shadow on grid area', 'struktur' )
			)
		);
		...
		struktur_select_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set border color for menu area', 'struktur' ),
			)
		);
		...
		struktur_select_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set background color for menu area', 'struktur' )
			)
		);
		...
		struktur_select_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set background transparency for menu area', 'struktur' ),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		$menu_area_border_container = struktur_select_add_admin_container(
			array(
				'parent'          => $menu_area_container,
		...
		do_action( 'struktur_select_header_menu_area_additional_options', $panel_header );
	}
	
	add_action( 'struktur_select_action_header_menu_area_options_map', 'struktur_select_header_menu_area_options_map', 10, 1 );
}