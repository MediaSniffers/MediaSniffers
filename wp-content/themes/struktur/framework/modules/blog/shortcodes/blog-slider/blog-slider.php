<?php
namespace StrukturCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog Slider', 'struktur' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'struktur' )            => 'slider',
							esc_html__( 'Carousel', 'struktur' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'struktur' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
					...
					array(
						...
						'save_always' => true,
						'dependency'  => array( 'element' => 'slider_type', 'value' => array('slider', 'carousel-centered' ) )
					),
					array(
						'type'        => 'textfield',
					...
					array(
						...
						'heading'     => esc_html__( 'Number of Words in Excerpt', 'struktur' ),
						'group'       => esc_html__( 'Post Info', 'struktur' )
					)
				)
			)
