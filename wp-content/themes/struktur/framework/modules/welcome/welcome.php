...
if ( ! class_exists( 'StrukturSelectWelcomePage' ) ) {
	class StrukturSelectWelcomePage {
		/**
		 * singleton class
		 */
		...
		/**
		 * get the instance of StrukturWelcomePage
		 *
		 * @return self
		 */
		...
		function welcome_page_content() {
			...
			$params['theme_screenshot']  = file_exists( STRUKTUR_SELECT_ROOT_DIR . '/screenshot.png' ) ? STRUKTUR_SELECT_ROOT . '/screenshot.png' : STRUKTUR_SELECT_ROOT . '/screenshot.jpg';

			echo struktur_select_get_html_module_template_part( 'templates/welcome', 'welcome', '', $params );
		}
		...
		function enqueue_styles( $hook ) {
			if ( $hook === 'appearance_page_struktur_select_welcome_page' ) {
				wp_enqueue_style( 'struktur-select-welcome-page-style', STRUKTUR_SELECT_FRAMEWORK_MODULES_ROOT . '/welcome/assets/admin/css/welcome.min.css' );
			}
		}
	}
}

StrukturSelectWelcomePage::get_instance();