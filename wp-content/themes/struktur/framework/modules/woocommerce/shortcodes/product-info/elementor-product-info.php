...
class StrukturElementorProductInfo extends \Elementor\Widget_Base {

    public function get_name() {
        return 'qodef_product_info';
    }

    public function get_title() {
        return esc_html__( 'Product Info', 'struktur' );
    }

    public function get_icon() {
        return 'struktur-elementor-custom-icon struktur-elementor-product-info';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'product_id',
            [
                'label'       => esc_html__( 'Selected Product', 'struktur' ),
        ...
        $this->add_control(
            'product_info_type',
            [
                'label'   => esc_html__( 'Product Info Type', 'struktur' ),
                'type'    => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'title'          => esc_html__( 'Title', 'struktur' ),
                    'featured_image' => esc_html__( 'Featured Image', 'struktur' ),
                    'category'       => esc_html__( 'Category', 'struktur' ),
                    'excerpt'        => esc_html__( 'Excerpt', 'struktur' ),
                    'price'          => esc_html__( 'Price', 'struktur' ),
                    'rating'         => esc_html__( 'Rating', 'struktur' ),
                    'add_to_cart'    => esc_html__( 'Add To Cart', 'struktur' ),
                    'tag'            => esc_html__( 'Tag', 'struktur' ),
                    'author'         => esc_html__( 'Author', 'struktur' ),
                    'date'           => esc_html__( 'Date', 'struktur' ),
                ],
                'default' => 'title'
            ]
        );
        ...
        $this->start_controls_section(
            'product_info_style',
            [
                'label' => esc_html__( 'Product Info Style', 'struktur' ),
                'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'product_info_color',
            [
                'label'     => esc_html__( 'Product Info Color', 'struktur' ),
        ...
        $this->add_control(
            'featured_image_size',
            [
                'label'     => esc_html__( 'Featured Image Proportions', 'struktur' ),
                'type'      => \Elementor\Controls_Manager::SELECT,
                'options'   => [
        ...
        $this->add_control(
            'category_tag',
            [
                'label'       => esc_html__( 'Category Tag', 'struktur' ),
                'type'        => \Elementor\Controls_Manager::SELECT,
        ...
        $this->add_control(
            'add_to_cart_skin',
            [
                'label'       => esc_html__( 'Add To Cart Skin', 'struktur' ),
                'type'        => \Elementor\Controls_Manager::SELECT,
                'options'     => [
                    ''      => esc_html__( 'Default', 'struktur' ),
                    'white' => esc_html__( 'White', 'struktur' ),
        ...
        $this->add_control(
            'add_to_cart_size',
            [
                'label'     => esc_html__( 'Add To Cart Size', 'struktur' ),
                'type'      => \Elementor\Controls_Manager::SELECT,
                'options'   => [
                    ''       => esc_html__( 'Default', 'struktur' ),
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new StrukturElementorProductInfo() );