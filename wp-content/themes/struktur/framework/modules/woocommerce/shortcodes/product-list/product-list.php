...
namespace StrukturCore\CPT\Shortcodes\ProductList;
...
class ProductList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List', 'struktur' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Product Info Position', 'struktur' ),
							'value'       => array(
								esc_html__( 'Info On Image Hover', 'struktur' ) => 'info-on-image',
								esc_html__( 'Info Below Image', 'struktur' )    => 'info-below-image'
							),
							'save_always' => true
						),
						array(
							'type'   	  => 'dropdown',
							'heading' 	  => esc_html__('Enable Animation', 'struktur'),
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Skin', 'struktur' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Text Alignment', 'struktur' ),
							'value'      => array(
								esc_html__( 'Default', 'struktur' ) => '',
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Bottom Margin (px)', 'struktur' ),
							'dependency' => array( 'element' => 'info_position', 'value'   => array( 'info-below-image' ) ),
							'group'      => esc_html__( 'Product Info Style', 'struktur' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = struktur_select_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list', $params['type'], $params, $additional_params );
