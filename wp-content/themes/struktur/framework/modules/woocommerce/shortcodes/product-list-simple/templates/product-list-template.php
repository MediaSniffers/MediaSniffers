    ...
    <ul class="qodef-pls-inner">
            ...
            <li class="qodef-pls-item">
                <div class="qodef-pls-image">
                    <a itemprop="url" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
                        <?php struktur_select_get_module_template_part('templates/parts/image-simple', 'woocommerce', '', $params); ?>
                    </a>    
                </div>
        ...
        <?php endwhile; else: ?>
            <li class="qodef-pls-messsage">
                <?php struktur_select_get_module_template_part('templates/parts/no-posts', 'woocommerce', '', $params); ?>
            </li>
        <?php endif;
            wp_reset_postdata();
        ?>
