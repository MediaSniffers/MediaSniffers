...
if ( class_exists( 'StrukturCoreClassWidget' ) ) {
	class StrukturSelectClassClassIconsGroupWidget extends StrukturCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'qodef_social_icons_group_widget',
				esc_html__( 'Struktur Social Icons Group Widget', 'struktur' ),
				array( 'description' => esc_html__( 'Use this widget to add a group of up to 6 social icons to a widget area.', 'struktur' ) )
			);
		...
		protected function setParams() {
			$this->params = array_merge(
				...
				struktur_select_icon_collections()->getSocialIconWidgetMultipleParamsArray( 6 ),
				array(
					array(
						'type'    => 'dropdown',
						'name'    => 'layout',
						'title'   => esc_html__( 'Icons Layout', 'struktur' ),
						'options' => array(
							''             => esc_html__( 'Default', 'struktur' ),
							'square-icons' => esc_html__( 'Square', 'struktur' ),
						)
					),
					array(
						'type'        => 'dropdown',
						'name'        => 'skin',
						'title'       => esc_html__( 'Square Icons Skin', 'struktur' ),
						'description' => esc_html__( 'This applies to the square layout', 'struktur' ),
						'options'     => array(
							''           => esc_html__( 'Dark Skin', 'struktur' ),
							'light-skin' => esc_html__( 'Light Skin', 'struktur' ),
						)
					),
					array(
						'type'    => 'dropdown',
						'name'    => 'alignment',
						'title'   => esc_html__( 'Text Alignment', 'struktur' ),
						'options' => array(
					...
					array(
						'type'  => 'textfield',
						'name'  => 'icon_size',
						'title' => esc_html__( 'Icons Size (px)', 'struktur' )
					),
					array(
						'type'  => 'colorpicker',
						'name'  => 'color',
