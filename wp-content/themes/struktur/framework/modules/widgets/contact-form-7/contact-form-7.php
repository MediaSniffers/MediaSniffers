...
if ( class_exists( 'StrukturCoreClassWidget' ) ) {
	class StrukturSelectClassContactForm7Widget extends StrukturCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'qodef_contact_form_7_widget',
				esc_html__( 'Struktur Contact Form 7 Widget', 'struktur' ),
				array( 'description' => esc_html__( 'Add contact form 7 to widget areas', 'struktur' ) )
			);
		...
		protected function setParams() {
			...
			$this->params = array(
				array(
					'type'  => 'textfield',
					'name'  => 'extra_class',
					'title' => esc_html__( 'Extra Class Name', 'struktur' )
				),
				array(
					'type'  => 'textfield',
				...
				array(
					'type'    => 'dropdown',
					'name'    => 'contact_form',
					'title'   => esc_html__( 'Select Contact Form 7', 'struktur' ),
					'options' => $contact_forms
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'contact_form_style',
					'title'   => esc_html__( 'Contact Form 7 Style', 'struktur' ),
					'options' => array(
		...
		public function widget( $args, $instance ) {
			...
			?>
			<div class="widget qodef-contact-form-7-widget <?php echo esc_attr( $extra_class ); ?>" <?php echo struktur_select_get_inline_style( $widget_styles ); ?>>
