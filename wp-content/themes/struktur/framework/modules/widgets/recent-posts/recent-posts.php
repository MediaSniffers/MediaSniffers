...
if ( class_exists( 'StrukturCoreClassWidget' ) ) {
	class StrukturSelectClassRecentPosts extends StrukturCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'qodef_recent_posts',
				esc_html__( 'Struktur Recent Posts', 'struktur' ),
				array( 'description' => esc_html__( 'Select recent posts that you would like to display', 'struktur' ) )
			);
		...
		public function widget( $args, $instance ) {
			...
			$html = '<div class="widget qodef-recent-post-widget" ' . struktur_select_get_inline_style( $widget_styles ) . '>';
			...
			if ( $query->have_posts() ) {
				...
				$html .= esc_html__( 'Sorry, there are no posts matching your criteria', 'struktur' );
			}
