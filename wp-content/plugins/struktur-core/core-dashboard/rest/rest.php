...
if ( ! class_exists( 'StrukturCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class StrukturCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'struktur-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'struktur_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	StrukturCoreDashboardRestAPI::get_instance();
}