...
class PortfolioList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio List', 'struktur-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Portfolio List Template', 'struktur-core' ),
							'value'       => array(
								esc_html__( 'Simple', 'struktur-core' ) => 'simple',
								esc_html__( 'Gallery', 'struktur-core' ) => 'gallery',
								esc_html__( 'Masonry', 'struktur-core' ) => 'masonry',
								esc_html__( 'Parallax', 'struktur-core' )  => 'parallax'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Click Behavior', 'struktur-core' ),
							'value'      => array(
								esc_html__( 'Open portfolio single page on click', 'struktur-core' )   => '',
								esc_html__( 'Open gallery in Pretty Photo on click', 'struktur-core' ) => 'gallery'
							),
						...
						array(
							...
							'value'       => array_flip( struktur_select_get_number_of_columns_array( true ) ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Fixed Image Proportions', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Image Shadow', 'struktur-core' ),
							'value'       => array_flip( struktur_select_get_yes_no_select_array( false ) ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'gallery', 'masonry' ) ),
							'save_always' => true
						),
						...
						array(
							...
							'heading'    => esc_html__( 'Item Style', 'struktur-core' ),
							'value'      => array(
								esc_html__( 'Standard - Zoom', 'struktur-core' )                   => 'standard-zoom',
								esc_html__( 'Standard - Grayscale', 'struktur-core' )              => 'standard-shader',
								esc_html__( 'Standard - Switch Featured Images', 'struktur-core' ) => 'standard-switch-images',
								esc_html__( 'Gallery - Custom Cursor', 'struktur-core' )           => 'gallery-overlay',
								esc_html__( 'Gallery - Slide From Image Bottom', 'struktur-core' ) => 'gallery-slide-from-image-bottom',
								esc_html__( 'Gallery - Follow Info', 'struktur-core' ) => 'gallery-follow-info'
							),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'gallery', 'masonry' ) ),
						...
						array(
							...
							'heading'    => esc_html__( 'Info Skin', 'struktur-core' ),
							'value'      => array(
								esc_html__( 'Default', 'struktur-core' )  => '',
								esc_html__( 'Light', 'struktur-core' )    => 'light'
							),
							'group'      => esc_html__( 'Content Layout', 'struktur-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'disable_item_border',
							'heading'    => esc_html__( 'Disable Item Bottom Border', 'struktur-core' ),
                        ...
                        array(
							...
							'heading'    => esc_html__( 'Content Top Margin (px or %)', 'struktur-core' ),
							'dependency' => array( 'element' => 'item_style', 'value' => array( 'standard-zoom', 'standard-shader', 'standard-switch-images' ) ),
							'group'      => esc_html__( 'Content Layout', 'struktur-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'content_bottom_margin',
							'heading'    => esc_html__( 'Content Bottom Margin (px or %)', 'struktur-core' ),
							'dependency' => array( 'element' => 'item_style', 'value' => array( 'standard-zoom', 'standard-shader', 'standard-switch-images' ) ),
							'group'      => esc_html__( 'Content Layout', 'struktur-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Title', 'struktur-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Enable Category', 'struktur-core' ),
							'value'      => array_flip( struktur_select_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Content Layout', 'struktur-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Number of Images', 'struktur-core' ),
							'value'      => array_flip( struktur_select_get_yes_no_select_array( false, true ) ),
							'dependency' => array( 'element' => 'type', 'value' => array( 'gallery' ) ),
							'group'      => esc_html__( 'Content Layout', 'struktur-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Excerpt', 'struktur-core' ),
							'value'      => array_flip( struktur_select_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Content Layout', 'struktur-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Excerpt Length', 'struktur-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Type', 'struktur-core' ),
							'value'      => array(
								esc_html__( 'None', 'struktur-core' )            => 'no-pagination',
								esc_html__( 'Standard', 'struktur-core' )        => 'standard',
								esc_html__( 'Load More', 'struktur-core' )       => 'load-more',
								esc_html__( 'Infinite Scroll', 'struktur-core' ) => 'infinite-scroll'
							),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'gallery', 'masonry' ) ),
							'group'      => esc_html__( 'Additional Features', 'struktur-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'load_more_top_margin',
							'heading'    => esc_html__( 'Load More Top Margin (px or %)', 'struktur-core' ),
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'filter',
							'heading'    => esc_html__( 'Enable Category Filter', 'struktur-core' ),
							'value'      => array_flip( struktur_select_get_yes_no_select_array( false ) ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'gallery', 'masonry' ) ),
							'group'      => esc_html__( 'Additional Features', 'struktur-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Order By', 'struktur-core' ),
							'value'      => array(
								esc_html__( 'Name', 'struktur-core' )  => 'name',
								esc_html__( 'Count', 'struktur-core' ) => 'count',
								esc_html__( 'Id', 'struktur-core' )    => 'id',
								esc_html__( 'Slug', 'struktur-core' )  => 'slug'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Filter Text Transform', 'struktur-core' ),
							'value'      => array_flip( struktur_select_get_text_transform_array( true ) ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'struktur-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Bottom Margin (px or %)', 'struktur-core' ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'struktur-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Enable Article Animation', 'struktur-core' ),
							'value'       => array_flip( struktur_select_get_yes_no_select_array( false ) ),
	...
	public function render( $atts, $content = null ) {
		...
		if ($params['portfolio_slider_on'] === 'yes') {
			$html = struktur_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-list', 'portfolio-holder-slider', $params['type'], $params, $additional_params );
		} else {
			$html = struktur_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-list', 'portfolio-holder', $params['type'], $params, $additional_params );
		}
