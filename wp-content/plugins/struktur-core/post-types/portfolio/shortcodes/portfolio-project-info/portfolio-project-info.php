...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function __construct() {
		$this->base = 'qodef_portfolio_project_info';
		
		add_action( 'vc_before_init', array( $this, 'vcMap' ) );
		
		//Portfolio project id filter
		add_filter( 'vc_autocomplete_qodef_portfolio_project_info_project_id_callback', array( &$this, 'portfolioIdAutocompleteSuggester', ), 10, 1 ); // Get suggestion(find). Must return an array
		
		//Portfolio project id render
		add_filter( 'vc_autocomplete_qodef_portfolio_project_info_project_id_render', array( &$this, 'portfolioIdAutocompleteRender', ), 10, 1 ); // Render exact portfolio. Must return an array (label,value)
	}
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'struktur-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'struktur-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Project Info Type', 'struktur-core' ),
							'value'       => array(
								esc_html__( 'Title', 'struktur-core' )              => 'title',
								esc_html__( 'Category', 'struktur-core' )           => 'category',
								esc_html__( 'Tag', 'struktur-core' )                => 'tag',
								esc_html__( 'Author', 'struktur-core' )             => 'author',
								esc_html__( 'Date', 'struktur-core' )               => 'date',
								esc_html__( 'Featured Image', 'struktur-core' )     => 'image',
								esc_html__( 'Whole Project Info', 'struktur-core' ) => 'whole_project_info'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Project Info Label', 'struktur-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Project Info Label Tag', 'struktur-core' ),
							'value'      => array_flip( struktur_select_get_title_tag( true, array( 'p' => 'p' ) ) ),
