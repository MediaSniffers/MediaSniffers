<?php
$custom_fields = get_post_meta($project_id, 'qodef_portfolio_properties', true);

if(is_array($custom_fields) && count($custom_fields)) :
	foreach($custom_fields as $custom_field) : ?>
		<div class="qodef-ps-info-item qodef-ps-custom-field">
			<?php if(!empty($custom_field['item_title'])) {
				struktur_core_get_cpt_single_module_template_part('templates/single/parts/info-title', 'portfolio', '', array( 'title' => $custom_field['item_title'] ) );
			} ?>
			<p>
