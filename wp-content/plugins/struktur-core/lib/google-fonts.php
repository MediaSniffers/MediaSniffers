<?php
if ( ! function_exists( 'struktur_select_init_google_fonts_array' ) ) {
    function struktur_select_init_google_fonts_array() {
...
';
        ...
        $struktur_select_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'struktur_select_init_google_fonts_array');
}