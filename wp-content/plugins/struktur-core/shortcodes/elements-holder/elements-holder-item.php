...
class ElementsHolderItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Elements Holder Item', 'struktur-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Padding', 'struktur-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'struktur-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'horizontal_alignment',
							'heading'    => esc_html__( 'Horizontal Alignment', 'struktur-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Vertical Alignment', 'struktur-core' ),
							'value'      => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Default (No Animation)', 'struktur-core' )   => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 1400px-1600px', 'struktur-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'struktur-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'struktur-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'item_padding_1025_1399',
							'heading'     => esc_html__( 'Padding on screen size between 1025px-1399px', 'struktur-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'struktur-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'struktur-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 768px-1024px', 'struktur-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'struktur-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'struktur-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 680px-768px', 'struktur-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'struktur-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'struktur-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size bellow 680px', 'struktur-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'struktur-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'struktur-core' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = struktur_core_get_shortcode_module_template_part( 'templates/elements-holder-item-template', 'elements-holder', '', $params );
