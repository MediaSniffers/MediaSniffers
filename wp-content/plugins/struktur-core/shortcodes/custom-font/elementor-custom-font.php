...
class StrukturCoreElementorCustomFont extends \Elementor\Widget_Base {

    public function __construct($data = [], $args = null) {
        parent::__construct($data, $args);

        wp_enqueue_script( 'typed', STRUKTUR_CORE_SHORTCODES_URL_PATH . '/custom-font/assets/js/plugins/typed.js', array( 'jquery' ), false, true );
    }
    ...
    public function get_title() {
        return esc_html__( 'Custom Font', 'struktur-core' );
    }

    public function get_icon() {
        return 'struktur-elementor-custom-icon struktur-elementor-custom-font';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'title',
            [
                'label'       => esc_html__( 'Title Text', 'struktur-core' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
            ]
        );
        ...
        $this->add_control(
            'type_out_effect',
            [
                'label'       => esc_html__( 'Enable Type Out Effect', 'struktur-core' ),
                'type'        => \Elementor\Controls_Manager::SELECT,
                'options'     => struktur_select_get_yes_no_select_array( false ),
                'description' => esc_html__( 'Adds a type out effect inside custom font content', 'struktur-core' )
            ]
        );
        ...
        $this->add_control(
            'type_out_position',
            [
                'label'       => esc_html__( 'Position of Type Out Effect', 'struktur-core' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'description' => esc_html__( 'Enter the position of the word after which you would like to display type out effect (e.g. if you would like the type out effect after the 3rd word, you would enter "3")', 'struktur-core' ),
                'condition' => [
        ...
        $this->add_control(
            'typed_color',
            [
                'label'     => esc_html__( 'Typed Color', 'struktur-core' ),
        ...
        $this->add_control(
            'typed_ending_1',
            [
                'label'     => esc_html__( 'Typed Ending Number 1', 'struktur-core' ),
                'type'      => \Elementor\Controls_Manager::TEXT,
                'condition' => [
                    'type_out_effect' => array( 'yes' )
                ],
        ...
        $this->add_control(
            'typed_ending_2',
            [
                'label'     => esc_html__( 'Typed Ending Number 2', 'struktur-core' ),
                'type'      => \Elementor\Controls_Manager::TEXT,
                'condition' => [
                    'typed_ending_1!' => ''
                ],
        ...
        $this->add_control(
            'typed_ending_3',
            [
                'label'     => esc_html__( 'Typed Ending Number 3', 'struktur-core' ),
                'type'      => \Elementor\Controls_Manager::TEXT,
                'condition' => [
                    'typed_ending_2!' => ''
                ],
        ...
        $this->add_control(
            'typed_ending_4',
            [
                'label'     => esc_html__( 'Typed Ending Number 4', 'struktur-core' ),
                'type'      => \Elementor\Controls_Manager::TEXT,
                'condition' => [
                    'typed_ending_3!' => ''
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => esc_html__( 'Enter the positions of the words after which you would like to create a line break (e.g. if you would like the line break after the 3rd and 8th words, you would enter "3,8")', 'struktur-core' ),
            ]
        );
        ...
        $this->add_control(
            'text_decoration',
            [
                'label'   => esc_html__( 'Text Decoration', 'struktur-core' ),
                'type'    => \Elementor\Controls_Manager::SELECT,
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'right'   => esc_html__( 'Center', 'struktur-core' ),
                    'justify' => esc_html__( 'Center', 'struktur-core' ),
                ]
            ]
        );
    ...
    public function render() {
        ...
        echo struktur_core_get_shortcode_module_template_part( 'templates/custom-font', 'custom-font', '', $params );
    }
    ...
    private function getModifiedTitle( $params ) {
        ...
        if ( ! empty( $title ) && ( $type_out_effect === 'yes' || ! empty( $title_break_words ) ) ) {
            ...
            if ( $type_out_effect === 'yes' && ! empty( $type_out_position ) ) {
                ...
                $typed_html = '<span class="qodef-cf-typed-wrap" ' . struktur_select_get_inline_style( $typed_styles ) . '><span class="qodef-cf-typed">';
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new StrukturCoreElementorCustomFont() );