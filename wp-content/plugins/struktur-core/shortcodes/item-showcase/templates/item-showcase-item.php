<div class="qodef-is-item <?php echo esc_attr($showcase_item_class); ?>">
	<div class="qodef-is-content">
		<?php if (!empty($item_title)) { ?>
			<<?php echo esc_attr($item_title_tag); ?> class="qodef-is-title" <?php echo struktur_select_get_inline_style($item_title_styles); ?>>
		...
		<?php if (!empty($item_text)) { ?>
			<p class="qodef-is-text" <?php echo struktur_select_get_inline_style($item_text_styles); ?>><?php echo esc_html($item_text); ?></p>
		<?php } ?>
	</div>
</div>