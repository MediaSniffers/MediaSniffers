<?php
namespace StrukturCore\CPT\Shortcodes\IconWithText;
...
class IconWithText implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Icon With Text', 'struktur-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array_merge(
						array(
							...
							array(
								...
								'value'       => array(
									esc_html__( 'Icon Left From Text', 'struktur-core' )  => 'icon-left',
									esc_html__( 'Icon Left From Title', 'struktur-core' ) => 'icon-left-from-title',
									esc_html__( 'Icon Top', 'struktur-core' )             => 'icon-top'
								),
								'save_always' => true
							)
						),
						struktur_select_icon_collections()->getVCParamsArray(),
						array(
							array(
								'type'       => 'attach_image',
								'param_name' => 'custom_icon',
								'heading'    => esc_html__( 'Custom Icon', 'struktur-core' )
							),
							array(
								'type'       => 'dropdown',
								'param_name' => 'icon_type',
								'heading'    => esc_html__( 'Icon Type', 'struktur-core' ),
								'value'      => array(
									esc_html__( 'Normal', 'struktur-core' ) => 'qodef-normal',
									esc_html__( 'Circle', 'struktur-core' ) => 'qodef-circle',
									esc_html__( 'Square', 'struktur-core' ) => 'qodef-square'
								),
								'group'      => esc_html__( 'Icon Settings', 'struktur-core' )
							),
							array(
								'type'       => 'dropdown',
								'param_name' => 'icon_size',
								'heading'    => esc_html__( 'Icon Size', 'struktur-core' ),
								'value'      => array(
									esc_html__( 'Medium', 'struktur-core' )     => 'qodef-icon-medium',
									esc_html__( 'Tiny', 'struktur-core' )       => 'qodef-icon-tiny',
									esc_html__( 'Small', 'struktur-core' )      => 'qodef-icon-small',
									esc_html__( 'Large', 'struktur-core' )      => 'qodef-icon-large',
									esc_html__( 'Very Large', 'struktur-core' ) => 'qodef-icon-huge'
								),
								'group'      => esc_html__( 'Icon Settings', 'struktur-core' )
							),
							array(
								...
								'heading'    => esc_html__( 'Custom Icon Size (px)', 'struktur-core' ),
								'group'      => esc_html__( 'Icon Settings', 'struktur-core' )
							),
							array(
								'type'       => 'textfield',
								'param_name' => 'shape_size',
								'heading'    => esc_html__( 'Shape Size (px)', 'struktur-core' ),
								'group'      => esc_html__( 'Icon Settings', 'struktur-core' )
							),
							array(
								'type'       => 'colorpicker',
								'param_name' => 'icon_color',
								'heading'    => esc_html__( 'Icon Color', 'struktur-core' ),
								'group'      => esc_html__( 'Icon Settings', 'struktur-core' )
							),
							array(
								'type'       => 'colorpicker',
								'param_name' => 'icon_hover_color',
								'heading'    => esc_html__( 'Icon Hover Color', 'struktur-core' ),
								'group'      => esc_html__( 'Icon Settings', 'struktur-core' )
							),
							array(
								'type'       => 'colorpicker',
								'param_name' => 'icon_background_color',
								'heading'    => esc_html__( 'Icon Background Color', 'struktur-core' ),
								'dependency' => array(
									'element' => 'icon_type',
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Hover Background Color', 'struktur-core' ),
								'dependency' => array(
									'element' => 'icon_type',
									'value'   => array( 'qodef-square', 'qodef-circle' )
								),
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Border Color', 'struktur-core' ),
								'dependency' => array(
									'element' => 'icon_type',
									'value'   => array( 'qodef-square', 'qodef-circle' )
								),
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Border Hover Color', 'struktur-core' ),
								'dependency' => array(
									'element' => 'icon_type',
									'value'   => array( 'qodef-square', 'qodef-circle' )
								),
							...
							array(
								...
								'heading'    => esc_html__( 'Border Width (px)', 'struktur-core' ),
								'dependency' => array(
									'element' => 'icon_type',
									'value'   => array( 'qodef-square', 'qodef-circle' )
								),
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Animation', 'struktur-core' ),
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Animation Delay (ms)', 'struktur-core' ),
							...
							array(
								...
								'group'       => esc_html__( 'Text Settings', 'struktur-core' )
							),
							array(
								'type'       => 'colorpicker',
							...
							array(
								...
								'heading'    => esc_html__( 'Title Top Margin (px)', 'struktur-core' ),
								'dependency' => array( 'element' => 'title', 'not_empty' => true ),
								'group'      => esc_html__( 'Text Settings', 'struktur-core' )
							),
							array(
							...
							array(
								'type'       => 'dropdown',
								'param_name' => 'target',
								'heading'    => esc_html__( 'Target', 'struktur-core' ),
							...
							array(
								...
								'heading'     => esc_html__( 'Text Padding (px)', 'struktur-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$default_atts = array_merge( $default_atts, struktur_select_icon_collections()->getShortcodeParams() );
		...
		return struktur_core_get_shortcode_module_template_part( 'templates/iwt', 'icon-with-text', $params['type'], $params );
	}
