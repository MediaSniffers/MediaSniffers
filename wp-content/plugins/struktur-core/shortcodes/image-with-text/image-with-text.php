<?php
namespace StrukturCore\CPT\Shortcodes\ImageWithText;
...
class ImageWithText implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image With Text', 'struktur-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Links Over Image', 'struktur-core' ) => 'links-over-image',
                        ...
                        array(
                            'type'        => 'dropdown',
                            'param_name'  => 'enable_custom_cursor',
                            'heading'     => esc_html__( 'Enable Custom Cursor', 'struktur-core' ),
                            'value'       => array_flip( struktur_select_get_yes_no_select_array( false ) ),
                            'save_always' => true,
                            'dependency' => Array( 'element' => 'image_behavior', 'value' => array( 'custom-link','lightbox','links-over-image' ) )
                        ),
						array(
							'type'       => 'textfield',
							'param_name' => 'custom_link',
							'heading'    => esc_html__( 'Custom Link', 'struktur-core' ),
							'dependency' => Array( 'element' => 'image_behavior', 'value' => array( 'custom-link' ) )
						),
                        array(
                            'type'       => 'textfield',
                            'param_name' => 'custom_link_one',
                            'heading'    => esc_html__( 'Custom Link One', 'struktur-core' ),
                            'dependency' => Array( 'element' => 'image_behavior', 'value' => array( 'links-over-image' ) )
                        ),
                        array(
                            'type'       => 'textfield',
                            'param_name' => 'link_text_one',
                            'heading'    => esc_html__( 'Link Text One', 'struktur-core' ),
                            'dependency' => Array( 'element' => 'image_behavior', 'value' => array( 'links-over-image' ) )
                        ),
                        array(
                            'type'       => 'textfield',
                            'param_name' => 'custom_link_two',
                            'heading'    => esc_html__( 'Custom Link Two', 'struktur-core' ),
                            'dependency' => Array( 'element' => 'image_behavior', 'value' => array( 'links-over-image' ) )
                        ),
                        array(
                            'type'       => 'textfield',
                            'param_name' => 'link_text_two',
                            'heading'    => esc_html__( 'Link Text Two', 'struktur-core' ),
                            'dependency' => Array( 'element' => 'image_behavior', 'value' => array( 'links-over-image' ) )
                        ),
						array(
							'type'       => 'dropdown',
							...
							'dependency' => Array( 'element' => 'image_behavior', 'value' => array( 'custom-link','links-over-image' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'title',
	...
	public function render( $atts, $content = null ) {
		...
		$html = struktur_core_get_shortcode_module_template_part( 'templates/image-with-text', 'image-with-text', '', $params );
