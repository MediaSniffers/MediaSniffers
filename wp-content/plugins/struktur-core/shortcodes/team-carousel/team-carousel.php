...
class TeamCarousel implements Lib\ShortcodeInterface {
    ...
    public function vcMap() {
	    if(function_exists('vc_map')) {
		    vc_map(
		    	array(
				    'name'     => esc_html__( 'Team Carousel', 'struktur-core' ),
				    'base'     => $this->base,
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div class="qodef-team-carousel-holder ' . esc_attr( $holder_classes ) . '">';
			$html .= '<div class="qodef-tc-inner qodef-owl-slider" ' . struktur_select_get_inline_attrs( $slider_data ) . '>';
