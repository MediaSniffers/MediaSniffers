<?php
namespace StrukturCore\CPT\Shortcodes\Tabs;
...
class Tabs implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Tabs', 'struktur-core' ),
					'base'            => $this->getBase(),
					...
					'params'          => array(
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Boxed', 'struktur-core' )    => 'boxed',
	...
	public function render( $atts, $content = null ) {
		...
		$output = struktur_core_get_shortcode_module_template_part( 'templates/tab-template', 'tabs', '', $params );
