<?php
namespace StrukturCore\CPT\Shortcodes\ClientsCarousel;
...
class ClientsCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Clients Carousel', 'struktur-core' ),
					'base'            => $this->getBase(),
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Items Hover Animation', 'struktur-core' ),
							'value'       => array(
								esc_html__( 'Switch Images', 'struktur-core' ) => 'switch-images',
								esc_html__( 'Roll Over', 'struktur-core' )     => 'roll-over'
							),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = struktur_core_get_shortcode_module_template_part( 'templates/clients-carousel', 'clients-carousel', '', $params );
