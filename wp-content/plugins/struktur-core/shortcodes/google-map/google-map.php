<?php
namespace StrukturCore\CPT\Shortcodes\GoogleMap;
...
class GoogleMap implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Google Map', 'struktur-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						array(
							'type'       => 'textfield',
							'param_name' => 'address1',
							'heading'    => esc_html__( 'Address 1', 'struktur-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'address2',
							'heading'    => esc_html__( 'Address 2', 'struktur-core' ),
							'dependency' => Array( 'element' => 'address1', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'address3',
							'heading'    => esc_html__( 'Address 3', 'struktur-core' ),
							'dependency' => Array( 'element' => 'address2', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'address4',
							'heading'    => esc_html__( 'Address 4', 'struktur-core' ),
							'dependency' => Array( 'element' => 'address3', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'address5',
							'heading'    => esc_html__( 'Address 5', 'struktur-core' ),
							'dependency' => Array( 'element' => 'address4', 'not_empty' => true )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'snazzy_map_style',
							'heading'     => esc_html__( 'Snazzy Map Style', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Snazzy Map Code', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Custom Map Style', 'struktur-core' ),
							'value'       => array_flip( struktur_select_get_yes_no_select_array( false ) ),
						...
						array(
							...
							'heading'     => esc_html__( 'Color Overlay', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Saturation', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Lightness', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Zoom Map on Mouse Wheel', 'struktur-core' ),
							'value'       => array_flip( struktur_select_get_yes_no_select_array( false ) ),
						...
						array(
							...
							'heading'    => esc_html__( 'Map Height', 'struktur-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = struktur_core_get_shortcode_module_template_part( 'templates/google-map-template', 'google-map', '', $params );
