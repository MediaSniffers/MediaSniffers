<?php
namespace StrukturCore\CPT\Shortcodes\Banner;
...
class Banner implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Banner', 'struktur-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Image Overlay Color', 'struktur-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hover_behavior',
							'heading'     => esc_html__( 'Hover Behavior', 'struktur-core' ),
							'value'       => array(
								esc_html__( 'Visible on Hover', 'struktur-core' )   => 'qodef-visible-on-hover',
								esc_html__( 'Visible on Default', 'struktur-core' ) => 'qodef-visible-on-default',
								esc_html__( 'Disabled', 'struktur-core' )           => 'qodef-disabled'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Position', 'struktur-core' ),
							'value'       => array(
								esc_html__( 'Default', 'struktur-core' )  => 'default',
								esc_html__( 'Centered', 'struktur-core' ) => 'centered'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Content Padding', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Subtitle Tag', 'struktur-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Subtitle Color', 'struktur-core' ),
							'dependency' => array( 'element' => 'subtitle', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'     => esc_html__( 'Words with Light Font Weight', 'struktur-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Link Text Color', 'struktur-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'link_top_margin',
							'heading'    => esc_html__( 'Link Text Top Margin (px)', 'struktur-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = struktur_core_get_shortcode_module_template_part( 'templates/banner', 'banner', '', $params );
