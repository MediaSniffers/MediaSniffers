<?php
namespace StrukturCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'struktur-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'struktur-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'struktur-core' ) => 'grid',
								esc_html__( 'Masonry', 'struktur-core' )    => 'masonry',
								esc_html__( 'Slider', 'struktur-core' )     => 'slider',
								esc_html__( 'Carousel', 'struktur-core' )   => 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							'type'        => 'attach_images',
							'param_name'  => 'images',
							'heading'     => esc_html__( 'Images', 'struktur-core' ),
							'description' => esc_html__( 'Select images from media library', 'struktur-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'image_size',
							'heading'     => esc_html__( 'Image Size', 'struktur-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Image Behavior', 'struktur-core' ),
							'value'      => array(
								esc_html__( 'None', 'struktur-core' )             => '',
								esc_html__( 'Open Lightbox', 'struktur-core' )    => 'lightbox',
								esc_html__( 'Open Custom Link', 'struktur-core' ) => 'custom-link',
								esc_html__( 'Zoom', 'struktur-core' )             => 'zoom',
								esc_html__( 'Grayscale', 'struktur-core' )        => 'grayscale'
							)
						),
						array(
							'type'        => 'textarea',
							'param_name'  => 'custom_links',
							'heading'     => esc_html__( 'Custom Links', 'struktur-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Custom Link Target', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'struktur-core' ),
							'value'       => array(
								esc_html__( 'One', 'struktur-core' )   => '1',
								esc_html__( 'Two', 'struktur-core' )   => '2',
								esc_html__( 'Three', 'struktur-core' ) => '3',
								esc_html__( 'Four', 'struktur-core' )  => '4',
								esc_html__( 'Five', 'struktur-core' )  => '5',
								esc_html__( 'Six', 'struktur-core' )   => '6'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'struktur-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_loop',
							'heading'     => esc_html__( 'Enable Slider Loop', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Autoplay', 'struktur-core' ),
							'value'       => array_flip( struktur_select_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'struktur-core' )
						...
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Slide Animation Duration', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'struktur-core' ),
							'value'       => array_flip( struktur_select_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'struktur-core' )
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'struktur-core' ),
							'value'       => array_flip( struktur_select_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'struktur-core' )
	...
	public function render( $atts, $content = null ) {
		...
		$html = struktur_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
