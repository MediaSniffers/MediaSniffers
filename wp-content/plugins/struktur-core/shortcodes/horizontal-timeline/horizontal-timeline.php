<?php
namespace StrukturCore\CPT\Shortcodes\HorizontalTimeline;
...
class HorizontalTimeline implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Horizontal Timeline', 'struktur-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						array(
							...
							'heading'     => esc_html__( 'Timeline displays?', 'struktur-core' ),
							'value'       => array(
								esc_html__( 'Only Years', 'struktur-core' )             => 'Y',
								esc_html__( 'Years and Months', 'struktur-core' )       => 'M Y',
								esc_html__( 'Years, Months and Days', 'struktur-core' ) => 'M d, \'y',
								esc_html__( 'Months and Days', 'struktur-core' )        => 'M d'
							),
							'admin_label' => true
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'distance',
							'heading'     => esc_html__( 'Minimal Distance Between Dates?', 'struktur-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = struktur_core_get_shortcode_module_template_part( 'templates/horizontal-timeline-holder', 'horizontal-timeline', '', $params );
