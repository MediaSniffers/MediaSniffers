...
class HorizontalTimelineItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Elated Horizontal Timeline Item', 'struktur-core' ),
					'base'            => $this->base,
					'category'        => esc_html__( 'by ELATED', 'struktur-core' ),
					...
					'params'          => array(
						array(
							'type'        => 'textfield',
							'param_name'  => 'date',
							'heading'     => esc_html__( 'Timeline Date', 'struktur-core' ),
							'description' => esc_html__( 'Enter date in format dd/mm/yyyy.', 'struktur-core' )
						),
						array(
							'type'       => 'attach_image',
							'param_name' => 'content_image',
							'heading'    => esc_html__( 'Content Image', 'struktur-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = struktur_core_get_shortcode_module_template_part( 'templates/horizontal-timeline-item', 'horizontal-timeline', '', $params );
