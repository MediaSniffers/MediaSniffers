...
if ( ! function_exists( 'struktur_core_add_pricing_tables_shortcodes' ) ) {
	function struktur_core_add_pricing_tables_shortcodes( $shortcodes_class_name ) {
		$shortcodes = array(
			'StrukturCore\CPT\Shortcodes\PricingTable\PricingTable',
			'StrukturCore\CPT\Shortcodes\PricingTable\PricingTableItem'
		);
...
if ( ! function_exists( 'struktur_core_set_pricing_table_custom_style_for_vc_shortcodes' ) ) {
	 ...
	 */
	function struktur_core_set_pricing_table_custom_style_for_vc_shortcodes( $style ) {
	...
	add_filter( 'struktur_core_filter_add_vc_shortcodes_custom_style', 'struktur_core_set_pricing_table_custom_style_for_vc_shortcodes' );
}
...
if ( ! function_exists( 'struktur_core_set_pricing_table_icon_class_name_for_vc_shortcodes' ) ) {
	 ...
	 */
	function struktur_core_set_pricing_table_icon_class_name_for_vc_shortcodes( $shortcodes_icon_class_array ) {
	...
	add_filter( 'struktur_core_filter_add_vc_shortcodes_custom_icon_class', 'struktur_core_set_pricing_table_icon_class_name_for_vc_shortcodes' );
}