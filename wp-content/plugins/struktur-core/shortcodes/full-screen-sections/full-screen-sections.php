...
class FullScreenSections implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Full Screen Sections', 'struktur-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						array(
							...
							'heading'     => esc_html__( 'Enable Continuous Scrolling', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Navigation Arrows', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Pagination Dots', 'struktur-core' ),
							'value'       => array_flip( struktur_select_get_yes_no_select_array( false, true ) ),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		wp_enqueue_script( 'fullPage', STRUKTUR_CORE_SHORTCODES_URL_PATH . '/full-screen-sections/assets/js/plugins/jquery.fullPage.min.js', array( 'jquery' ), false, true );
		
		$html = struktur_core_get_shortcode_module_template_part( 'templates/full-screen-sections', 'full-screen-sections', '', $params );
