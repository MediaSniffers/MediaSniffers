<?php
namespace StrukturCore\CPT\Shortcodes\FullScreenSections;
...
class FullScreenSectionsItem implements Lib\ShortcodeInterface {
	...
	function __construct() {
		$this->base = 'qodef_full_screen_sections_item';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Full Screen Sections Item', 'struktur-core' ),
					'base'            => $this->base,
					'as_child'        => array( 'only' => 'qodef_full_screen_sections' ),
					...
					'params'          => array(
						...
						array(
							...
							'heading'    => esc_html__('Background Image', 'struktur-core')
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'background_position',
							'heading'     => esc_html__( 'Background Image Position', 'struktur-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Size', 'struktur-core' ),
							'value'       => array(
								esc_html__( 'Cover', 'struktur-core' )   => 'cover',
								esc_html__( 'Contain', 'struktur-core' ) => 'contain',
								esc_html__( 'Inherit', 'struktur-core' ) => 'inherit'
							),
							'save_always' => true,
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'padding',
							'heading'     => esc_html__( 'Content Padding', 'struktur-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. You can use px or %', 'struktur-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'vertical_alignment',
							'heading'     => esc_html__( 'Content Vertical Alignment', 'struktur-core' ),
							'value'       => array(
								esc_html__( 'Default', 'struktur-core' ) => '',
								esc_html__( 'Top', 'struktur-core' )     => 'top',
								esc_html__( 'Middle', 'struktur-core' )  => 'middle',
								esc_html__( 'Bottom', 'struktur-core' )  => 'bottom'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Content Horizontal Alignment', 'struktur-core' ),
							'value'       => array(
								esc_html__( 'Default', 'struktur-core' ) => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Header and Navigation Skin', 'struktur-core' ),
							'value'       => array(
								esc_html__( 'Default', 'struktur-core' ) => '',
								esc_html__( 'Light', 'struktur-core' )   => 'light',
								esc_html__( 'Dark', 'struktur-core' )    => 'dark'
							),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__('Background Image for Laptops', 'struktur-core'),
							'group'       => esc_html__('Responsiveness', 'struktur-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet',
							'heading'     => esc_html__('Background Image for Tablets - Landscape', 'struktur-core'),
							'group'       => esc_html__('Responsiveness', 'struktur-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet_portrait',
							'heading'     => esc_html__('Background Image for Tablets - Portrait', 'struktur-core'),
							'group'       => esc_html__('Responsiveness', 'struktur-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_mobile',
							'heading'     => esc_html__('Background Image for Mobiles', 'struktur-core'),
							'group'       => esc_html__('Responsiveness', 'struktur-core')
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = struktur_core_get_shortcode_module_template_part( 'templates/full-screen-sections-item', 'full-screen-sections', '', $params );
