<?php if ( is_array( $post_ratings ) && count( $post_ratings ) ) { ?>
	<?php $average_rating_total = struktur_core_get_total_average_rating( $post_ratings ); ?>
				...
				<div class="qodef-grid-col-3">
					<div class="qodef-item-reviews-average-wrapper">
						<div class="qodef-item-reviews-average-rating">
							<?php echo esc_html( struktur_core_reviews_format_rating_output( $average_rating_total ) ); ?>
						</div>
						<div class="qodef-item-reviews-verbal-description">
                            <span class="qodef-item-reviews-rating-icon">
                                <?php echo struktur_core_reviews_get_icon_for_rating( $average_rating_total ); ?>
                            </span>
							<span class="qodef-item-reviews-rating-description">
                                <?php echo esc_html( struktur_core_reviews_get_description_for_rating( $average_rating_total ) ); ?>
                            </span>
						</div>
					</div>
				</div>
				<div class="qodef-grid-col-9">
					<div class="qodef-rating-percentage-wrapper">
						...
						foreach ( $post_ratings as $rating ) {
							$percentage = struktur_core_post_average_rating_per_criteria( $rating );
