...
include 'struktur-instagram-helper.php';

/**
 * Class StrukturInstagramApi
 */
class StrukturInstagramApi {
	/**
	...
	private $apiURL;
	/**
	 * @var StrukturInstagramApi instance of current class
	 */
	private static $instance;
	
	/**
	 * Helper object
	 * @var StrukturInstagramHelper
	 */
	private $helper;
	
	const CODE_OPTION_NAME = 'struktur_instagram_code';
	const USER_ID_OPTION_NAME = 'struktur_instagram_user_id';
	const ACCESS_TOKEN_OPTION_NAME = 'struktur_instagram_access_token';
	const CODE_REDIRECT_URI_OPTION_NAME = 'struktur_instagram_code_redirect_uri';
	...
	public function __construct() {
		...
		$this->redirectUri  = defined( 'STRUKTUR_SELECT_PROFILE_SLUG' ) ? 'http://demo.' . STRUKTUR_SELECT_PROFILE_SLUG . '-themes.com/instagram-app/instagram-redirect.php' : '';
		...
		$this->helper       = new StrukturInstagramHelper();
	}
	 ...
	 * @return string
	 *
	 * @see StrukturInstagramApi::buildCurrentPageURI()
	 */
	...
	/**
	 * @return StrukturInstagramHelper
	 */
	 ...
	 *
	 * @see StrukturInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see StrukturInstagramApi::getAccessToken()
	 */
