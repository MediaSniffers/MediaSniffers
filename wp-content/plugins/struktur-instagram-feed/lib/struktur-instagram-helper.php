...
/**
 * Class StrukturInstagramHelper
 */
class StrukturInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines struktur_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image, $imageSize ) {
		...
		$imageAtts = apply_filters( 'struktur_instagram_image_atts',
			array(
				'class'  => $imageSize,
